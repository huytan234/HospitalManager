...
namespace QL_BenhVien
{
    public partial class FrmChiTietBacSi : Form
    {
        ...
        private void FrmChiTietBacSi_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd1 = new SqlCommand("select ho,ten,id from BacSi where  taikhoan=@p1", _conn.connection());
        ...
        private void btnSuaTT_Click(object sender, EventArgs e)
        {
            ...
            FrmThayDoiThongTinBacSi fr = new FrmThayDoiThongTinBacSi();
            fr.getHo = ho;
            fr.getTen = ten;
            fr.BacSiSlectedID = idBacSi;
            fr.Show();
            this.Hide();
        }
        ...
        {
            int secilen = dataGridView1.SelectedCells[0].RowIndex;
            mota.Text = dataGridView1.Rows[secilen].Cells[3].Value.ToString();
        }

        private void btnThongBao_Click(object sender, EventArgs e)
        {
            FrmThongBao fr = new FrmThongBao();
            fr.Show();
            this.Hide();
        }
